...
$cmd sentry.user sentry.organization sentry.organizationmember sentry.team sentry.project sentry.projectteam | grep -v "\[WARNING\]" > data/sentry_data.json
...
cat data/sentry_data.json|jq '[.[] | select(.model=="sentry.project") | .model="projects.project" | .fields.created=.fields.date_added | del(.fields.public) | del(.fields.status) | del(.fields.forced_color) | del(.fields.flags) | del(.fields.platform) | del(.fields.date_added)]' > data/projects_project.json
